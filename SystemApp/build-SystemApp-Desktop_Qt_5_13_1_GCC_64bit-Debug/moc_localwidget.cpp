...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_LocalWidget_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_LocalWidget_t qt_meta_stringdata_LocalWidget = {
    {
QT_MOC_LITERAL(0, 0, 11) // "LocalWidget"
...
QT_INIT_METAOBJECT const QMetaObject LocalWidget::staticMetaObject = { {
    &QDockWidget::staticMetaObject,
    qt_meta_stringdata_LocalWidget.data,
    qt_meta_data_LocalWidget,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *LocalWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_LocalWidget.stringdata0))
